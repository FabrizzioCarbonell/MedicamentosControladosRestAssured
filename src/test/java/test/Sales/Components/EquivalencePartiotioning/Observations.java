...
public class Observations {
    ...
    public void ObservationsWithABC(){
        RestAssured.baseURI = "https://dev.sicarx.com";
        String endpoint = "/sale/v1/sale";

        String observations = "SE VENDE DESDE INTELIJ";
        SalesDTO sales = SaleFunction.createSale("123456879", "Dr. Fabrizzio Carbonell", "Aa1Bb2Cc3Dd4Ee5", observations,"123", false);
    ...
    @Test
    @Tag("EquivalencePartitioning")
    public void ObservationsWithSpecialCharacters(){
        RestAssured.baseURI = "https://dev.sicarx.com";
        String endpoint = "/sale/v1/sale";

        String observations = "@@ Se %^$ !!@!# #@##";
        SalesDTO sales = SaleFunction.createSale("123456879", "Dr. Fabrizzio Carbonell", "Aa1Bb2Cc3Dd4Ee5", observations,"123", false);
